...
<head>
	<!-- 
	Error page for HTTP error 404 (Page Not Found).
	Written by Thanh Ba Nguyen <btnguyen2k@gmail.com>
	Copyleft 2012
	-->
	<title>Page Not Found Error @ DASP</title>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="alert alert-error alert-block">
				<h4 class="alert-heading">Page Not Found Error @ DASP</h4>
				The page you are looking for was not found. If you feel this to be a
				real problem, please contact the Site Administrator.
			</div>
		</div>
		<div class="row-fluid">
