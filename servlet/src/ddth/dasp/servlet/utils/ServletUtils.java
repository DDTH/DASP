...
public class ServletUtils {
     ...
     * @throws IOException
     */
    public static void responseError(int errorCode, String errorMsg, HttpServletResponse response)
            throws IOException {
     ...
     *            Object
     */
    public static void setContextAttribute(ServletContext context, String name, Object value) {
    ...
    static public String getContextServletPathURI(HttpServletRequest request) {
        String contextServletPath = getContextPathURI(request) + getServletPath(request);
    ...
    static public String getContextServletPathURL(HttpServletRequest request) {
        String contextServletPath = getContextPathURL(request) + getServletPath(request);
        if (!contextServletPath.equals("/")) {
            contextServletPath = contextServletPath.replaceAll("/$", "");
        }
        return contextServletPath;
     ...
     */
    static public URL loadResourceAsURL(GenericServlet servlet, String resourcePath)
            throws MalformedURLException {
     ...
     * @throws MalformedURLException
     */
    static public URL loadResourceAsURL(String resourcePath) throws MalformedURLException {
     ...
     * @throws MalformedURLException
     */
    static public URL loadResourceAsURL(ServletContext servletContext, String resourcePath)
            throws MalformedURLException {
     ...
     * @return InputStream
     */
    static public InputStream loadResourceAsStream(GenericServlet servlet, String resourcePath) {
     ...
     * @return InputStream
     */
    static public InputStream loadResourceAsStream(ServletContext servletContext,
            String resourcePath) {
     ...
     * @throws IOException
     */
    static public String loadResourceAsString(GenericServlet servlet, String resourcePath)
            throws IOException {
     ...
     * @throws IOException
     */
    static public String loadResourceAsString(String resourcePath) throws IOException {
     ...
     * @throws IOException
     */
    static public String loadResourceAsString(ServletContext servletContext, String resourcePath)
            throws IOException {
    ...
    static public String loadResourceAsString(GenericServlet servlet, String resourcePath,
        ...
        return loadResourceAsString(servlet.getServletContext(), resourcePath, charset);
    }
     ...
     * @throws IOException
     */
    static public String loadResourceAsString(String resourcePath, String charset)
            throws IOException {
