...
public class ThriftServiceBootstrapServlet extends GenericServlet {

    private static final long serialVersionUID = 1L;

    private static final Logger LOGGER = LoggerFactory
            .getLogger(ThriftServiceBootstrapServlet.class);
    ...
    public void init() throws ServletException {
        ...
        TProcessor processor = new DaspJsonService.Processor<DaspJsonService.Iface>(
                new DaspJsonServiceHandler());
        try {
