...
public abstract class AbstractRequestParser implements IRequestParser {
    ...
    private final static Logger LOGGER = LoggerFactory.getLogger(AbstractRequestParser.class);

    private long maxContentLength = DEFAULT_MAX_POST_SIZE;
    ...
    public void setMaxContentLength(long maxContentLength) {
        this.maxContentLength = maxContentLength < 1 ? DEFAULT_MAX_POST_SIZE : maxContentLength;
     ...
     *             thrown when the buffer is overload
     */
    protected void write(byte[] data, int offset, int length) throws MalformedRequestException {
        if (data != null) {
            this.isDirty = true;
     ...
     * @throws MalformedRequestException
     */
    protected abstract void internalParseRequest() throws RequestParsingInteruptedException,
