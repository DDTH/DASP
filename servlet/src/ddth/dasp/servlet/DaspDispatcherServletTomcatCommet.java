...
public class DaspDispatcherServletTomcatCommet extends HttpServlet implements CometProcessor {
    ...
    protected void doHandleRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (requestHandler == null) {
            ServletUtils.responseHttpError(response, IApiHandler.RESULT_CODE_NOT_IMPLEMETED,
                    "No handler found!");
            return;
        }
