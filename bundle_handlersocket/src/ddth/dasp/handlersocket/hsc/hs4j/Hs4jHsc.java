...
public class Hs4jHsc implements IHsc {
    ...
    protected String calcHash(String dbName, String tableName, String tableIndexName,
            String[] columns) {
    ...
    protected IndexSession openIndex(String dbName, String tableName, String tableIndexName,
        ...
        synchronized (indexSessions) {
            ...
            if (indexSession == null) {
                hsClient.openIndexSession(dbName, tableName, tableIndexName, columns);
            }
            return indexSession;
        }
    }
     ...
     */
    @Override
    public boolean insert(String dbName, String tableName, String tableIndexName, String[] columns,
        ...
        try {
            IndexSession indexSession = openIndex(dbName, tableName, tableIndexName, columns);
     ...
     */
    @Override
    public int update(String dbName, String tableName, String tableIndexName, String[] columns,
            Object[] values, Object[] findValues) throws SQLException {
        if (!isReadWrite()) {
            String msg = "This Handler Socket connection is read-only!";
            throw new SQLException(msg);
        }
        try {
            ...
            for (int i = 0; i < findValues.length; i++) {
                keys[i] = findValues[i] != null ? findValues[i].toString() : null;
            }
     ...
     */
    @Override
    public int delete(String dbName, String tableName, String tableIndexName, String[] columns,
     ...
     */
    @Override
    public ResultSet select(String dbName, String tableName, String tableIndexName,
            String[] columns, Object[] findValues) throws SQLException {
        return select(dbName, tableName, tableIndexName, columns, findValues, Integer.MAX_VALUE, 0);
    }
    ...
    @Override
    public ResultSet select(String dbName, String tableName, String tableIndexName,
            String[] columns, Object[] findValues, int limit) throws SQLException {
        return select(dbName, tableName, tableIndexName, columns, findValues, limit, 0);
    }
    ...
    @Override
    public ResultSet select(String dbName, String tableName, String tableIndexName,
            String[] columns, Object[] findValues, int limit, int offset) throws SQLException {
        try {
            IndexSession indexSession = openIndex(dbName, tableName, tableIndexName, columns);
            String[] keys = new String[findValues.length];
            for (int i = 0; i < findValues.length; i++) {
