 ...
 */
public abstract class JsonRestApiHandler extends RestApiHandler implements Controller {

    private Logger LOGGER = LoggerFactory.getLogger(JsonRestApiHandler.class);
