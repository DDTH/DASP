 ...
 */
public abstract class DelegateRestApiHandler extends DelegateApiHandler implements Controller {

    private Logger LOGGER = LoggerFactory.getLogger(DelegateRestApiHandler.class);
     ...
     * @throws IOException
     */
    protected String parseAuthKey(HttpServletRequest request) throws ApiException, IOException {
     ...
     * @throws IOException
     */
    protected abstract Object parseInput(HttpServletRequest request) throws ApiException,
            IOException;
     ...
     * @throws IOException
     */
    protected abstract void returnResult(HttpServletResponse response, Object result)
