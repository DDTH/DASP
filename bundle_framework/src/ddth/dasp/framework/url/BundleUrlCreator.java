...
public class BundleUrlCreator implements IUrlCreator, ServletContextAware {
	 ...
	 */
	@Override
	public String createUrl(String[] virtualParams,
	 ...
	 */
	@Override
	public String createUrl(HttpServletResponse response,
			String[] virtualParams, Map<String, Object> urlParams) {
		return createUrl(response, virtualParams, urlParams, urlSuffix, false,
				false);
	}
	...
	@Override
	public String createUrl(String[] virtualParams,
			Map<String, Object> urlParams, String urlSuffix,
			boolean absoluteUrl, boolean forceHttps) {
		return createUrl(httpResponse, virtualParams, urlParams, urlSuffix,
				absoluteUrl, forceHttps);
	}
	...
	public String createUrl(HttpServletResponse response,
		...
		if (virtualParams != null && virtualParams.length > 0) {
		...
		return response != null ? response.encodeURL(url.toString()) : url
				.toString();
	}
	...
	protected ServletContext getServletContext() {
		return servletContext != null ? servletContext : DaspGlobal
				.getServletContext();
	}
}
