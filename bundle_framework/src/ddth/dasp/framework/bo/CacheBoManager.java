...
public abstract class CacheBoManager extends BaseBoManager {
	...
	private long cacheCapcity = 0, cacheCapcityForNull = 0,
			expireAfterWrite = -1, expireAfterAccess = -1;
	...
	public ICache getCacheForNull() {
		if (cacheForNull == null && cacheEnabled() && cacheNull) {
			...
			cacheForNull = cacheManagerForNull.createCache(cacheNameForNull,
					cacheCapcityForNull, cacheNullExpiry, -1);
		}
		return cacheForNull;
	}
